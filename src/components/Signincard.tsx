...
const Signincard = () => {
  ...
  return (
    <div className="h-full flex justify-center items-center py-8 px-4">
      <div className="bg-white shadow-md rounded-lg p-6 md:p-8 w-full max-w-md mx-auto">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-4
                focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2.5" disabled={loading}
            >
              {loading ? (
